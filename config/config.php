...
/**
 * MealKit – Application Configuration
 * =====================================
 * Central constants and settings for the entire application.
 * All environment-specific values live here – no hard-coded
 * strings should appear anywhere else in the codebase.
 *
 * XAMPP defaults are pre-configured. Adjust before production.
 */
...
define('MOMO_API_KEY',        'SANDBOX-API-KEY-REPLACE-IN-PRODUCTION');
define('MOMO_MERCHANT_ID',    'MEALKIT_MERCHANT_001');
